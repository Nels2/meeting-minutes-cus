...
export function SettingsModals({
  ...
  return <>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-2">
                    <select
                      className="px-3 py-2 text-sm bg-white dark:bg-gray-950 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <select
                      className="flex-1 px-3 py-2 text-sm bg-white dark:bg-gray-950 border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-100 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                ...
                {modelConfig.provider === 'ollama' && (
                  <div>
                    <h4 className="text-lg font-bold mb-4 text-gray-900 dark:text-gray-100">Available Ollama Models</h4>
                    {error && (
                    ...
                    <div className="grid gap-4 max-h-[400px] overflow-y-auto pr-2">
                      {models.map((model) => (
                        <div
                          key={model.id}
                          className={`bg-white dark:bg-gray-950 p-4 rounded-lg shadow cursor-pointer transition-colors ${modelConfig.model === model.name ? 'ring-2 ring-blue-500 bg-blue-50 dark:bg-blue-950/40' : 'hover:bg-gray-50 dark:hover:bg-gray-800'
                            }`}
                          onClick={() => setModelConfig((prev: ModelConfig) => ({ ...prev, model: model.name }))}
                        >
                          <h3 className="font-bold">{model.name}</h3>
                          <p className="text-gray-600 dark:text-gray-400">Size: {model.size}</p>
                          <p className="text-gray-600 dark:text-gray-400">Modified: {model.modified}</p>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg max-w-4xl w-full mx-4 shadow-xl max-h-[90vh] flex flex-col">
          ...
          <div className="p-6 pt-4 border-t border-gray-200 dark:border-gray-800 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Show Confidence Indicators</p>
    ...
    {modals.errorAlert && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <Alert className="max-w-md mx-4 border-red-200 dark:border-red-900 bg-white dark:bg-gray-900 shadow-xl">
    ...
    {modals.chunkDropWarning && (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <Alert className="max-w-lg mx-4 border-yellow-200 dark:border-yellow-900 bg-white dark:bg-gray-900 shadow-xl">
