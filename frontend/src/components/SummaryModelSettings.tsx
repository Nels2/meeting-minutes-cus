...
export function SummaryModelSettings({ refetchTrigger }: SummaryModelSettingsProps) {
  ...
  return (
    <div className='flex flex-col gap-4'>
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">Auto Generating summary after meeting completion(Stopping)</p>
          </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6 shadow-sm">
        <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-gray-100">Summary Model Configuration</h3>
