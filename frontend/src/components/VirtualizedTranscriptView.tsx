        ...
        <div id={`segment-${id}`} className="mb-3">
            <div className="flex items-start gap-2">
                ...
                <div className="flex-1">
                    {speaker && (
                        <span className="inline-block text-xs font-medium px-1.5 py-0.5 rounded mb-1 mr-1 bg-blue-100 text-blue-700 dark:bg-blue-950/50 dark:text-blue-300">
                            {speaker === 'mic' ? 'Mic' : speaker === 'system' ? 'System' : speaker}
                        </span>
                    )}
                    {isStreaming ? (
